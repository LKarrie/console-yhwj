...
import ArrayInputWithDisabled from '../ArrayInputWithDisabled'
import styles from './index.scss'

@trigger
export default class EnvironmentInputWithDisabled extends React.Component {
  constructor(props) {
    super(props)
    ...
    this.state = { configMaps: [], secrets: [], canEditIndex: [] }
  ...
  handleEdit(index) {
    ...
    if (!canEditIndex.includes(index)) {
      this.setState({ canEditIndex: [...canEditIndex, index] })
    } else {
      this.setState({ canEditIndex: canEditIndex.filter(e => e !== index) })
    }
  }
  ...
  render() {
    ...
    const { configMaps, secrets, canEditIndex } = this.state
    return (
      <ArrayInputWithDisabled
